...
def main(_):
  ...
  FLAGS.config.reward_wrapper.pretrained_path = "/tmp/xirl/pretrain_runs/dataset=xmagical_mode=same_algo=xirl_embodiment=shortstick/dataset=xmagical_mode=same_algo=xirl_embodiment=shortstick/"
